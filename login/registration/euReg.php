...
if (isset($_POST['submit'])) {
	...
	if($mysqli->query("INSERT INTO eu(userId,insName,firstName,lastName,euDiv,addLine1,addLine2,province,district,contactNoOffice,contactNoMobile) VALUES('" . $_SESSION['userId'] . "','" . $institute . "','" . $firstName . "', '" . $lastName . "', '" . $euDiv . "', '" . $addLine1 . "', '" . $addLine2 . "', '" . $province . "', '" . $district . "', '" . $contactNoOffice . "', '" . $contactNoMobile . "')")){
...
<body>
<form class="jotform-form" action="<?php echo $_SERVER['PHP_SELF'];?>" method="post" name="euRegForm" accept-charset="utf-8">
  <input type="hidden" name="formID" value="63242846468464" />
  <div class="form-all">
    <ul class="form-section page-section">
      ...
      <li class="form-line jf-required" data-type="control_textbox" id="id_4">
        ...
        <div id="cid_4" class="form-input jf-required">
          <input type="text" class=" form-textbox validate[required]" data-type="input-textbox" id="input_4" name="euDiv" size="20" value="" />
        </div>
      </li>
