...
if (isset($_POST['submit'])) {
	...
	if($mysqli->query("INSERT INTO moh(userId,insName,firstName,lastName,mohRegNo,mohArea,addLine1,addLine2,province,district,contactNoOffice,contactNoMobile) VALUES('" . $_SESSION['userId'] . "','" . $institute . "','" . $firstName . "', '" . $lastName . "', '" . $mohRegNo . "', '" . $mohArea . "', '" . $addLine1 . "', '" . $addLine2 . "', '" . $province . "', '" . $district . "', '" . $contactNoOffice . "', '" . $contactNoMobile . "')")){
...
<body>
<form class="jotform-form" action="<?php echo $_SERVER['PHP_SELF'];?>" method="post" name="mohRegForm" accept-charset="utf-8">
  <input type="hidden" name="formID" value="63242627388462" />
  <div class="form-all">
    <ul class="form-section page-section">
      ...
      <li class="form-line jf-required" data-type="control_textbox" id="id_4">
        ...
        <div id="cid_4" class="form-input jf-required">
          <input type="text" class=" form-textbox validate[required]" data-type="input-textbox" id="input_4" name="mohRegNo" size="20" value="" />
        </div>
      </li>
      <li class="form-line jf-required" data-type="control_textbox" id="id_22">
        ...
        <div id="cid_22" class="form-input jf-required">
          <input type="text" class=" form-textbox validate[required]" data-type="input-textbox" id="input_22" name="mohArea" size="20" value="" />
        </div>
      </li>
