            ...
            <div class="panel-body" >
                <table class="table">
					...
					if ($row = $result->fetch_assoc()) {
						...
						'<tr><td align="right"><b>Hospital - Permanent : </b></td><td align="left">'.$row['hospPermanent'].'</td></tr>'.
						'<tr><td align="right"><b>Hospital 2 : </b></td><td align="left">'.$row['hospital2'].'</td></tr>'.
						'<tr><td align="right"><b>Hospital 3 : </b></td><td align="left">'.$row['hospital3'].'</td></tr>'.
						'<tr><td align="right"><b>Hospital 4 : </b></td><td align="left">'.$row['hospital4'].'</td></tr>'.
						'<tr><td align="right"><b>Hospital 5 : </b></td><td align="left">'.$row['hospital5'].'</td></tr>'.
						'<tr><td align="right"><b>Other Hospital : </b></td><td align="left">'.$row['otherHospital'].'</td></tr>';
					}
					?>
                </table>
            </div>
