        ...
        <div class="panel panel-default">
            <div class="panel-body">
			   ...
			   <?php
					...
					$result = $mysqli->query("SELECT * FROM phi WHERE userId = '" .$_SESSION['userId']. "'");
            ...
            <div class="panel-body" >
                <table class="table">
					...
					if ($row = $result->fetch_assoc()) {
						...
						'<tr><td align="right"><b>Registration No : </b></td><td align="left">'.$row['phiRegNo'].'</td></tr>'.
						'<tr><td align="right"><b>PHI Range : </b></td><td align="left">'.$row['phiRange'].'</td></tr>'.
